<x-app-layout>
    ...
    <div class="container">
        <div class="flex justify-center">
            <a href="/">
                <x-shared.logo class="h-20 fill-current text-gray-500" />
            </a>
        </div>
        <div class="w-full mx-auto sm:max-w-md mt-6 px-6 py-4 bg-white dark:bg-gray-800 shadow-card overflow-hidden sm:rounded-lg">
